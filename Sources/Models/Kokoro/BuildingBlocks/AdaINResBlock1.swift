  ...
  init(
    ...
    for i in 0 ..< 3 {
      ...
      let conv = ConvWeighted(
        weightG: try KokoroWeights.require(weights, weightPrefixKey + ".convs1.\(i).weight_g"),
        weightV: try KokoroWeights.require(weights, weightPrefixKey + ".convs1.\(i).weight_v"),
        bias: try KokoroWeights.require(weights, weightPrefixKey + ".convs1.\(i).bias"),
        stride: 1,
    ...
    for i in 0 ..< 3 {
      let conv = ConvWeighted(
        weightG: try KokoroWeights.require(weights, weightPrefixKey + ".convs2.\(i).weight_g"),
        weightV: try KokoroWeights.require(weights, weightPrefixKey + ".convs2.\(i).weight_v"),
        bias: try KokoroWeights.require(weights, weightPrefixKey + ".convs2.\(i).bias"),
        stride: 1,
    ...
    for i in 0 ..< 3 {
      adain1Arr.append(AdaIN1d(
        ...
        fcWeight: try KokoroWeights.require(weights, weightPrefixKey + ".adain1.\(i).fc.weight"),
        fcBias: try KokoroWeights.require(weights, weightPrefixKey + ".adain1.\(i).fc.bias")
      ))

      adain2Arr.append(AdaIN1d(
        styleDim: styleDim,
        numFeatures: channels,
        fcWeight: try KokoroWeights.require(weights, weightPrefixKey + ".adain2.\(i).fc.weight"),
        fcBias: try KokoroWeights.require(weights, weightPrefixKey + ".adain2.\(i).fc.bias")
      ))
    }

    for i in 0 ..< 3 {
      alpha1Arr.append(try KokoroWeights.require(weights, weightPrefixKey + ".alpha1.\(i)"))
      alpha2Arr.append(try KokoroWeights.require(weights, weightPrefixKey + ".alpha2.\(i)"))
    }
