...
class Decoder: Module {
  ...
  init(
    ...
    self._F0Conv.wrappedValue = ConvWeighted(
      weightG: try KokoroWeights.require(weights, "decoder.F0_conv.weight_g"),
      weightV: try KokoroWeights.require(weights, "decoder.F0_conv.weight_v"),
      bias: try KokoroWeights.require(weights, "decoder.F0_conv.bias"),
      stride: 2,
      padding: 1,
      groups: 1
    )
    self._NConv.wrappedValue = ConvWeighted(
      weightG: try KokoroWeights.require(weights, "decoder.N_conv.weight_g"),
      weightV: try KokoroWeights.require(weights, "decoder.N_conv.weight_v"),
      bias: try KokoroWeights.require(weights, "decoder.N_conv.bias"),
      stride: 2,
      padding: 1,
      groups: 1
    )
    ...
    self._asrRes.wrappedValue = [ConvWeighted(
      weightG: try KokoroWeights.require(weights, "decoder.asr_res.0.weight_g"),
      weightV: try KokoroWeights.require(weights, "decoder.asr_res.0.weight_v"),
      bias: try KokoroWeights.require(weights, "decoder.asr_res.0.bias"),
      padding: 0
    )]
